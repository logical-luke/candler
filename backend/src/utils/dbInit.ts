    ...
    },
    {
        ...
        sql: `
            ALTER TABLE indicators
                ADD COLUMN IF NOT EXISTS computed_indicators TEXT[];
        `
    },
    {
        version: 3,
        description: 'Modify indicators table to handle dynamic indicators',
        sql: `
            ALTER TABLE indicators
                DROP COLUMN IF EXISTS computed_indicators;
            ALTER TABLE indicators
                ADD COLUMN IF NOT EXISTS computed_indicators JSONB DEFAULT '{}';
        `
    },
];
